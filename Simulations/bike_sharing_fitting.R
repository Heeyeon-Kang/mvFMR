...
##############################################################################
####          R-code of fitting the bike sharing data presented           ####
####                           in Section 6.2.                            ####
##############################################################################

# The following R-code fits the bike sharing data presented in Section 6.2 using 
# parallel computing.
...
parallel_OUTPUTS <- foreach(K = 1:6,
                            .combine = list,
...
save(BIC_SCAD_s, file="./BIC_SCAD_bike_sharing.rdata")
save(optimal_OUTPUTS_s, file="./optimal_OUTPUTS_bike_sharing.rdata")
save(optimal_w_s, file="./optimal_w_bike_sharing.rdata")
save(optimal_density_s, file="./optimal_density_bike_sharing.rdata")
save(total_OUTPUTS_s, file="./total_OUTPUTS_bike_sharing.rdata")
save(total_w_s, file="./total_w_bike_sharing.rdata")
save(total_density_s, file="./total_density_bike_sharing.rdata")
